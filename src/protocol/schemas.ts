...
export const adapterFailureDiagnosticsSchema = z.strictObject({
  ...
  maximum_inspection_turns: nonNegativeInteger.optional(),
  remaining_inspection_turns: nonNegativeInteger.optional(),
  ...
  circuit_cause: z
    .strictObject({
      reviewer_id: nonEmptyString.max(128),
      attempt: nonNegativeInteger,
      reason: nonEmptyString.max(128),
      at: z.iso.datetime({ offset: true }),
      failure_code: nonEmptyString.max(128).optional(),
    })
    .optional(),
